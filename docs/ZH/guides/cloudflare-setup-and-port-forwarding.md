...
注意事项：
基础信息：
备注：可以给每个规则写一个别名 以及TCP或者UDP协议
出口配置：
局域网出口类型：选择“微服虚拟网卡（仅微服应用容器内可访问）”
微服虚拟网卡：“host.lzcapp” 端口：尽量与需要映射的端口一致
目标配置：
转发目标类型：微服应用
微服应用：选择需要映射的应用（这一有个注意点：这个下拉应用选项中需要选运行中的，据自身服务来）

添加完成之后点击“测试目标连接正常————>创建规则
```
![image-20260316155042851](images/image-20260316155042851.png)

![image-20260316155655908](images/image-20260316155655908.png)

![image-20260316155556703](images/image-20260316155556703.png)
